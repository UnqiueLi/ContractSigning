...
var _login = _interopRequireDefault(__webpack_require__(/*! ./subpkg_login/pages/login/login.vue */ 143));
// @ts-ignore
...
/* harmony import */ var _login_vue_vue_type_template_id_15ef082d___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./login.vue?vue&type=template&id=15ef082d& */ 144);
                  ...
                  case 0:
                    if (loginRes.code) {
                      ...
                      _user.authApi.decryptPhone(parmas).then(function (res) {
                        _this2.phoneNumber = "15794119711";
                        uni.setStorageSync('phoneNumber', _this2.phoneNumber);
                        _this2.getMyLogin();
                      });
                    }
                  case 1:
